...
## Description
Bow precision with one arrow at a time. Earn shots by eliminating opponents.
...
- Dedicated play region selection.
- Classic one-shot gameplay loop.
...
- `/baa game <id> add micro one_in_the_chamber` — Attach this microgame module to the arena.
- `/baa stick` — Get the setup tool to select regions.
- `/baa game <id> one_in_the_chamber bounds set` — Save the game bounds for this arena.
- `/baa game <id> one_in_the_chamber spawn add` — Add spawn points for players.
- `/baa game <id> one_in_the_chamber time <minutes>` — Set the match duration.

### Module-specific steps
Finish the setup with the commands below:
- `/baa game <id> one_in_the_chamber setmode <last_standing|most_kills>` — Choose the win condition.
- `/baa game <id> one_in_the_chamber setregion set` — Select and save the play region.

## Technical details
- **Microgame ID:** `one_in_the_chamber`
