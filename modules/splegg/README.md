...
- `/baa game <id> add micro splegg` — Attach this microgame module to the arena.
- `/baa stick` — Get the setup tool to select regions.
- `/baa game <id> splegg bounds set` — Save the game bounds for this arena.
- `/baa game <id> splegg spawn add` — Add spawn points for players.
- `/baa game <id> splegg time <minutes>` — Set the match duration.

### Module-specific steps
Finish the setup with the commands below:
- `/baa game <id> splegg floor set` — Select and save the floor region.
